...
- **change_location**: Wenn der User den ORT des bereits ENTSCHIEDENEN Termins ändern oder entfernen will ("Location tauschen", "X raus", "nimm stattdessen Y"), rufe change_location auf (leer = entfernen). NICHT ask_search dafür nehmen, und NICHT behaupten, es sei erledigt, ohne den Tool-Call zu machen.
