...
- **start_smalltalk**: NUR wenn der User AUSDRÜCKLICH um Smalltalk bittet ("mach mal Smalltalk"). Nicht aufrufen, nur weil ein Thema erwähnt wurde, und nicht während die Agenten gerade den Termin verhandeln.
